...
#define SRC_VERTEX_SHADER TOP_SRC_DIR"CoordinateSystems/Exercises/texture2.vs"
#define SRC_FRAGMENT_SHADER TOP_SRC_DIR"CoordinateSystems/Exercises/texture2.fs"
...
int main(int argc, char** argv) {
    ...
    glm::mat4 mview(1.f);
    mview = glm::translate(mview, {-3.f, 3.f, -5.f});
