...
"out vec4 FragColor;\n"
"void main() {\n"
"    FragColor = vec4(1.f, 1.f, 0.2f, 0.01f);\n"
"}\0";
...
bool init_rectangle(unsigned int* VAO, unsigned int* shaderProgram) {
    float vertices[] = {
...
int main(int args, char** argv) {
    ...
    unsigned int rectVAO, rectShaderProgram;
    init_rectangle(&rectVAO, &rectShaderProgram);
